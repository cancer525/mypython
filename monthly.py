...
month=4
# 段落
content1="<font fontsize=12>&nbsp代码安全审计主要是通过找出代码中存在的潜在安全风险并修复，"+str(month)+"以提高应用系统代码质量，降低系统安全风险。"\
         "自2020年9月份上线以来，</font><font fontsize=12>代码安全子系统在云道平台安全审计中心稳定运行。<br/>"\
         "&nbsp&nbsp&nbsp&nbsp本报告基于云道平台安全审计中心代码安全检测子系统的检测数据进行统计分析，内容分为两大部分：</font>"\
         "<font fontsize=12>第一部分介绍了2021年1-4月每个月代码安全检测的情况以及趋势。第二部分介绍了4月份的总体检测情况、安全缺陷情况。</font>"
...
# file
doc = SimpleDocTemplate('C:\\Users\\eric\\Desktop\\hello2.pdf')
doc.build(story)