...
with open("C:/Users/Shayla/Desktop/毕业论文/last/Total/Total2010.txt", "r",encoding='UTF-8') as f:  # 打开文件
    data = f.read()  # 读取文件
    print(len(data))
...
data0.to_excel("C:/Users/Shayla/Desktop/毕业论文/last/Total/excel/Total2010.xlsx")
